...
|---|---|---|
| **Deadlock Detection & Recovery Simulator** | Interactive Operating Systems simulator detecting and recovering from deadlocks using 3 classic algorithms and 4 strategies. Features a live animated Resource Allocation Graph. Built as an OS course project at PAF-IAST. | [View Project](https://github.com/OwaisTanoli71/Deadlock-Simulator) |
| **Smart Hostel Management System** | Full-stack PHP & MySQL hostel management system with dual-role portals (Admin & Student). Features room allocation, fee tracking, complaint management, and notifications. Built as a 4th Semester DB course project at PAF-IAST. | [View Project](https://github.com/OwaisTanoli71/Hostel-Management-System) |
...
| **maxN · 3-Player Game Tree Simulator** | Full-stack Python/Flask web app for visualising 3-player Minimax and Alpha-Beta Pruning with a complete alliance system. Features glassmorphic UI and 6 built-in examples. Live on Vercel. | [View Project](https://github.com/OwaisTanoli71/maxn-simulator) · [Live Demo](https://maxn-simulator.vercel.app) |
...
- **Languages:** Python, C++, PHP, MySQL, HTML & CSS
...
- **Web Development:** Flask, PHP 8, PDO, Jinja2, REST APIs
- **Tools:** Jupyter Notebook, Google Colab, Docker, Git/GitHub, Streamlit, Vercel
